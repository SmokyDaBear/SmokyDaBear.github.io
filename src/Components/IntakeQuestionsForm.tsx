        ...
        <form className="wizard-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className={stepClass(0)}>
            <div className="step-label">
              Step 1 of 5 &middot; Your Business
            </div>
          ...
          <div className={stepClass(1)}>
            <div className="step-label">Step 2 of 5 &middot; About You</div>
          ...
          <div className={stepClass(2)}>
            <div className="step-label">
              Step 3 of 5 &middot; Contact Info
            </div>
          ...
          <div className={stepClass(3)}>
            <div className="step-label">Step 4 of 5 &middot; Your Project</div>
          ...
          <div className={stepClass(4)}>
            <div className="step-label">
              Step 5 of 5 &middot; Final Details
            </div>
