...
export function SendIcon(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M21 3 14 21a.55.55 0 0 1-1 0l-3-7-7-3a.55.55 0 0 1 0-1L21 3Z" />
    </Svg>
  );
}
...
/* --- Service icons (mapped by id from data/site.ts) --- */
...
export function PaletteIcon(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.93 0 1.65-.75 1.65-1.68 0-.43-.17-.82-.46-1.12-.28-.3-.44-.69-.44-1.11 0-.93.75-1.68 1.68-1.68H16c3.31 0 6-2.69 6-6 0-4.96-4.5-8.41-10-8.41Z" />
    </Svg>
  );
}
...
export function serviceIcon(id: string, size = 24): ReactNode {
  switch (id) {
    case "code":
